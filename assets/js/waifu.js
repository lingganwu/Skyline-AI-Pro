...
function skySend(){
    ...
    var fd=new FormData();fd.append('action','sky_chat_front');fd.append('msg',m);fd.append('_ajax_nonce', skyline_vars.nonce);
    ...
    fetch(skyline_vars.ajax_url, {method:'POST',body:fd}).then(r=>r.json()).then(d=>{
