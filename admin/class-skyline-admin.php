            ...
            <div class="sky-sidebar">
                <div class="sky-brand">
                    ...
                    <div>
                        ...
                        <span class="sky-brand-ver">Enterprise v2.0</span>
                    </div>
                </div>
                <div class="sky-nav">
                ...
                <?php if ($current_tab === 'dashboard'): ?>
                    <div class="sky-card">
                        ...
                        <p style="color: var(--sky-text-muted); line-height: 1.6; font-size: 14px;">
                            Skyline AI Pro 是您的智能运营中台。集成 <b>DeepSeek V3</b> 顶尖模型，实现 AI 写作润色与绘图；通过 <b>Skyline Sync</b> 实现无感同步集成，支持智能去水印。配合 <b>Redis 缓存</b>与 <b>OSS 云存储</b>，将您的站点速度推向极致。
                        </p>
                    </div>
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 30px;">
                        ...
                        <div class="sky-card">
                            ...
                            <div style="font-size: 13px; color: var(--sky-text-muted); line-height: 1.8;">
                                <b>v2.0.0</b> - 旗舰级架构重建，全量还原配置项，引入企业级视觉语言<br>
                                <b>v1.5.0</b> - 视觉架构升维，引入 SaaS 级组件库，增强合规性<br>
                                <b>v1.4.0</b> - 引入 Redis 对象缓存，优化同步架构
                            </div>
                        </div>
                    </div>
                <?php else: ?>
                    <!-- SETTINGS VIEW: NO SIMPLIFICATION, FULL DETAIL -->
                    <div class="sky-settings-grid">
                        <?php 
                        // Group settings into logical blocks for the current tab
                        $current_group_items = [];
                        ...
                        // Split items into multiple blocks if there are many (e.g., 6 per block)
